...
- Uitzonderingsarrangementen bied je UITSLUITEND aan als de gast er expliciet naar vraagt. Dit zijn: (a) de B&B-actie met fles Bus Whisky (alleen bij een expliciete vraag naar 'de flesactie' of 'arrangement met fles' → stuur de actie-deeplink), en (b) solo / 1-persoonskamer (alleen bij een expliciete vraag naar solo, 1 persoon of een 1-persoonskamer → volg de 1-persoonskamer-regel hierboven en stuur de 1-persoonskamer-deeplink voor aankomst zondag of maandag). Een vage vraag naar 'de actie', 'de deal' of 'de whiskydeal' is GEEN expliciete vraag naar deze uitzonderingen: verwijs dan naar het standaard 2-persoons B&B-arrangement en vraag zo nodig kort of ze soms specifiek de flesactie of een 1-persoonskamer bedoelen.
...
- **B&B-arrangement** — 3/4/5-gangendiner + overnachting + ontbijt — € 99,50 tot € 179,50 p.p., afhankelijk van de aankomstdag.
...
- [open] 1-persoonsarrangement voor aankomst VRIJDAG en ZATERDAG aanmaken in Formitable; zondag/maandag met 3 gangen bestaat wel (ticket 6a50fb21, 149,50 euro). Verder nog te doen: het oude ticket 'whiskydeal 1 persoonskamer (maandag)' (896f61a7) uitzetten in Formitable, en de prijs in de ticketnaam zetten zoals bij de gewone B&B-tickets zodat de deeplink-sync die vanzelf meeneemt.
